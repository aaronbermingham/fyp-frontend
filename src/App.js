      ...
      <div>
        <div>
          <Navbar collapseOnSelect expand="lg" bg="primary" variant="dark">
            <Container>
              {businessUser && (
                <Navbar.Brand href={"/home"} bg="primary" variant="dark">
                  {!currentUser ? <h2>book + eat</h2> : <h2>b+e</h2>}
                </Navbar.Brand>
              )}
              {!businessUser && (
                <Navbar.Brand href={"/home"} bg="primary" variant="dark">
                ...
                <Nav className="mr-auto">
                  ...
                  {businessUser && (
                    <NavDropdown title="Items" id="collasible-nav-dropdown">
                      <NavDropdown.Item href={"/addFoodItem"}>
                        Add food
                      </NavDropdown.Item>
                      <NavDropdown.Item href={"/addDrinkItem"}>
                        Add drink
                      </NavDropdown.Item>
                      <NavDropdown.Item href={"/allItems"}>
                        View all
                      </NavDropdown.Item>
                    </NavDropdown>
                  )}
                  {businessUser && (
                    <NavDropdown title="Staff" id="collasible-nav-dropdown">
                      ...
                      <NavDropdown.Item href={"/allStaff"}>
                        View all staff
                      </NavDropdown.Item>
                      <NavDropdown.Item href={"/assignShift"}>
                        Add staff shift
                      </NavDropdown.Item>
                    </NavDropdown>
                  )}
                  {businessUser && (
                    <NavDropdown title="Tables" id="collasible-nav-dropdown">
                      <NavDropdown.Item href={"/addTable"}>
                        Add a table
                      </NavDropdown.Item>
                      <NavDropdown.Item href={"/allTables"}>
                        Manage tables/Capacity
                      </NavDropdown.Item>
                    </NavDropdown>
                  )}
                  {businessUser && (
                    ...
                    >
                      <NavDropdown.Item href={"/contactTracing"}>
                        Trace a customer
                      </NavDropdown.Item>
                      <NavDropdown.Item href={"/staffContactTracing"}>
                        Trace staff
                      </NavDropdown.Item>
                    </NavDropdown>
                  )}
        ...
        <div className="container mt-3">
          <Switch>
            ...
            ></Route>
            <Route exact path="/userHome" component={UserHomeComponent}></Route>
            ...
            <Route
              path="/staffContactTracing"
              component={StaffContactTracing}
            ></Route>
