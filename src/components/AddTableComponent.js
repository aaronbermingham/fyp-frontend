...
class AddTableComponent extends Component {
  ...
  createTable = (e) => {
    ...
    for (var i = 0; i < this.state.numTables; i++) {
      TableService.addTable(table, localStorage.getItem("resId")).then(
        (res) => {
                  ...
                  <form>
                    <div className="form-group">
                      ...
                      <select
                        ...
                        selected={this.state.numSeats}
                        onChange={this.changeSeatHandler}
                      >
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        name="numTables"
                        className="form-control"
                        selected={this.state.numTables}
                        onChange={this.changeTableHandler}
                      >
                    ...
                    <div className="form-group">
                      ...
                      <Form.Group controlId="formBasicCheckbox">
                        <Form.Check
                          type="checkbox"
                          label="Yes"
                          selected={this.state.outdoor}
                          onClick={this.changeOutdoorHandler}
                        />
                      </Form.Group>
                    </div>
