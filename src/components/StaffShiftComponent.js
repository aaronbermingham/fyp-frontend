...
class StaffShiftComponent extends Component {
    constructor(props){
        super(props)
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                <form>
                                    ...
                                    <div className = "form-group">
                                        <label>ABV</label>
                                        <input placeholder="Alcohol By Volume" name="alcoholByVolume" className = "form-control"
                                            value ={this.state.alcoholByVolume} onChange = {this.changeAbvHandler}/>
                                    </div>
                        
                                    <button className = "btn btn-success" onClick={this.updateDrinkItem}>Update drink</button>
...
export default StaffShiftComponent