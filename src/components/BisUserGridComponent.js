          ...
          <CardColumns className="text-center">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>View/Manage bookings</Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">
                  {" "}
                  <Card.Link href="/allBookings">
                    <h4>Click here</h4>
                  </Card.Link>
                </small>
              </Card.Footer>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>View/Manage Food items</Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">
                  {" "}
                  <Card.Link href="/allItems">
                    <h4>Click here</h4>
                  </Card.Link>
                </small>
              </Card.Footer>
            ...
            <Card bg="primary" text="white" className="text-center p-3">
              <blockquote className="blockquote mb-0 card-body">
                <p>Business Section Add items View bookings etc</p>
              </blockquote>
            </Card>
            <Card>
              <svg
              ...
              <Card.Body>
                ...
                <Card.Text>Add a new food item to the menu</Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">
                  <Card.Link href="/addFoodItem">
                    <h4>Click here</h4>
                  </Card.Link>
                </small>
              </Card.Footer>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>Add a new drink to the menu</Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">
                  <Card.Link href="/addDrinkItem">
                    <h4>Click here</h4>
                  </Card.Link>
                </small>
              </Card.Footer>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>View/manage users</Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">
